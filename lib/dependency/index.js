...
function () {
  ...
  */
  ...
  (0, _createClass2["default"])(Dependency, [{
    ...
    key: "displayAuthor",
    get: function get() {
      var mainAuthor = this.authors[0];

      if (this.authors.length === 1) {
        return mainAuthor;
      }

      var authorLastName = mainAuthor.split('. ').pop();
      return "".concat(authorLastName, " et al.");
    }
  }], [{
    key: "create",
...
var buildDependencies = function buildDependencies() {
